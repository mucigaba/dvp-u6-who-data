...
There does not appear to be an exact correlation of GDP and life expectancy.
...
Zimbabwe has the greatest change in life expectancy although its growth in GDP has been somewhat flat. China has the greatest change in GDP. Chile and Germany both have higher life expectancies than the US but smaller GDPs. Mexico is more comparable to the US in terms of life expectancy and China is catching up quickle. GDP does not appear to directly correlate to life expectancy. Things like lifestyle factors, culture, access to health care, and inequalities in economic distribution might also be factors.
...
China moves the most along the X axis, Zimbabwe moves the most along the Y. Neither is surprising given the amount of initial difference.
...
The US has the highest GDP. Zimbabwe has the lowest.
...
Writing for the HuffPost, John Ross, senior fellow at the Chongyang Institue, points to state investment as the leading factor in China's exponential growth in GDP. While Western growth has slowed down due to a downturn in private investement, he aregues, China has been able to maintain a strong growth rate through public investment.
